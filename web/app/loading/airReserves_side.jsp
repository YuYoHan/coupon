...
<div class="FloatContainer-container">
	...
	<div class="PurchaseButton-buttonWrapper">
		<span role="button" class="css-w0pi5v">
			<a style="width: 100%;" href="${cp}/pay/airPayment.pm?datefilter=${param.datefilter}&airline=${param.airline}&airnum=${param.airnum}&dep=${param.dep}&arr=${param.arr}&price=${param.price}&useremail=${loginUser.useremail}">
